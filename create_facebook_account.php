  ...
  if(isset($_POST['btn'])){
      try{
         $frist_name=$_POST['frist_name'];
          ...
          $sql="INSERT INTO tbl_facebook(frist_name,sur_name,mobile_number,address)"
                   ."VALUES(:fname,:sname,:mnumber,:address)";
...
echo "facebook data is not sucessfully : " . $e->getMessage();
      }
  }
    }
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="bg_text">
                                                ...
                                                <p style="margin-top:50px;"> <img class="img" src="https://static.xx.fbcdn.net/rsrc.php/v3/yi/r/OBaVg52wtTZ.png" alt="" width="537" height="195"></p>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="header">
                                                ...
                                                <form action="view_facebook_account.php" method="post">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <input type="name" name="frist_name"  required class="form-control" placeholder="First name">
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <input type="name" name="sur_name" class="form-control" placeholder="surname">
                                                        </div>
                                                        <div class="col-lg-12">
                                                            <div class="name">
                                                                <input type="text" name="mobile_number" class="form-control" placeholder="Mobile number or email address">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12">
                                                            <div class="address">
                                                                <input type="name" name="address" class="form-control" placeholder="present address">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="button">
                                                    <button type="submit"name="btn" class="btn btn-success">Sign Up</button>
                                                 </div>
                                                </form>
                                            </div>
                                        </div>
